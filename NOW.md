...
- [ ] 「v1 核心」(C15)指哪些 ID?建議 = I14 + B2 + W12(C++/Py 語言包),其餘入職後按 C14 解鎖。
      — v0 88 h + W12 16 h = 104 h 對上剩餘 38 天的 81–108 h,只有頂緣塞得下。
...
- W12 語言包(C++ quant/Google/NV/Linux 級 + Python/Bazel tests)已開 issue #13,
  milestone「v1 core — pre-Etched」(2026-08-28,Withers 新增範圍;worker 仍是 Rust)。
